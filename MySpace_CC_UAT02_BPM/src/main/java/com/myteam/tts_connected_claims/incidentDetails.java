...
public class incidentDetails implements java.io.Serializable {
	...
	@javax.persistence.ManyToOne(cascade = {javax.persistence.CascadeType.ALL}, fetch = javax.persistence.FetchType.EAGER)
	@org.kie.api.definition.type.Label("caseStatusBO")
	private com.myteam.tts_connected_claims.caseStatusBO caseStatusBO;
	...
	public com.myteam.tts_connected_claims.caseStatusBO getCaseStatusBO() {
		return this.caseStatusBO;
	}

	public void setCaseStatusBO(
			com.myteam.tts_connected_claims.caseStatusBO caseStatusBO) {
		this.caseStatusBO = caseStatusBO;
	}
